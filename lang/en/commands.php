...
return [
    ...
    'update' => [
        'preparation_failed' => 'The update was not prepared. No application files were changed.',
        'source_required' => 'Provide --source with the extracted target release directory so its locked platform requirements can be verified.',
        'retention_invalid' => 'The --retain value must be at least 1.',
        'snapshot_created' => 'Pre-update snapshot created at: :path',
        'snapshot_missing' => 'No complete pre-update snapshot was found. Keep the Panel in maintenance mode and restore from your external backup.',
        'snapshot_incomplete' => 'The pre-update snapshot is incomplete and cannot be used: :path',
        'snapshot_write_failed' => 'The required snapshot artifact could not be written: :artifact',
        'snapshot_permissions_failed' => 'Restrictive permissions could not be applied to snapshot artifact: :artifact',
        'snapshot_prune_failed' => 'An expired protected snapshot could not be removed: :path',
        'compatibility_passed' => 'Composer platform requirements for the target release are compatible with this server.',
        'compatibility_files_missing' => 'The target release directory must contain composer.json and composer.lock.',
        'compatibility_exception' => 'Composer platform validation could not start: :error',
        'compatibility_command_failed' => "Composer platform validation failed:\n:details",
        'composer_binary_missing' => 'The requested Composer executable could not be found: :binary',
        'composer_binary_required' => 'Composer could not be located. Provide its executable or PHAR path with --composer.',
        'no_command_output' => 'Composer returned no additional output.',
        'environment_missing' => 'The Panel .env file does not exist and cannot be captured.',
        'database_connection_failed' => 'The configured database connection could not be inspected: :error',
        'sqlite_database_missing' => 'The configured SQLite database does not exist and cannot be captured.',
        'database_backup_sqlite' => 'A consistent SQLite backup was captured at :path.',
        'database_backup_mysql' => 'Create and verify a consistent database backup before updating, for example with mysqldump --single-transaction --quick --lock-tables=false.',
        'database_backup_pgsql' => 'Create and verify a consistent database backup before updating, for example with pg_dump --format=custom.',
        'database_backup_unknown' => 'Create and verify a database backup using the tools recommended for the configured :driver driver.',
        'database_guidance' => 'Database backup guidance: :guidance',
        'ready' => 'Pre-update validation passed. Keep the snapshot until the post-update health check succeeds.',
        'healthy' => 'The post-update health check passed. The snapshot may be archived or removed after final verification.',
        'unhealthy' => 'The update is not healthy. Keep the Panel in maintenance mode and follow the rollback guide at: :path',
    ],
    'make_node' => [
